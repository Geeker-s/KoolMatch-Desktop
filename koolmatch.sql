...
--
-- Hôte : localhost:8889
-- Généré le : dim. 15 mai 2022 à 21:18
...
('DoctrineMigrations\\Version20220510020431', '2022-05-10 02:04:49', 358);
...
(4, 0, 'pour préparer des croissants', 'on a besoin de farine', 'on a besoin de sucre', 'on a besoin de Harissa', 'on a besoin de chocolat', 'pour cuisiner des croissants', 'on a besoin de four', 'on a besoin de micro onde', 'on a besoin gaz', 'on a besoin de frigidaire', 'pour un petit dej familiale', '500 g de farine', '100 g de farine', '700 g de  farine', '300 g de farine', 0),
...
(11, 0, 'aze', 'a', 'a', 'aa', 'aaa', 'bb', 'bb', 'bb', 'bbb', 'bbb', 'cc', 'cc', 'cc', 'ccc', 'cccc', 0);
...
(0, 'pain au choc', 'back/assets/img/users/83668_w1024h576c1cx2880cy1920.jpg', 'Farine 500g  sucre 50g  sel12g jaune d oeuif lai', 'petit Dej', 60, 0),
(6, 'hamburgezer', 'src/tn/edu/esprit/images/src/tn/edu/esprit/images/src/tn/edu/esprit/images/src/tn/edu/esprit/images/null', '500 g de farine 100 ml de lait 1 oeuf 1 c. à café de sel 3 c. à café de sucre', 'Dejeuner', 30, 0),
...
(38, '2022-06-10', 7, 37, 1, 0, 'azeazeaze', 'src/tn/edu/esprit/images/26e7ff4a43c2b568ef806ec79ba3777f.jpeg', 'aeazeaea');
...
(37, 'azeazeaze', 'aeazeaea', 44444444, 'azeaea', 'azeaze', 2, 'src/tn/edu/esprit/images/26e7ff4a43c2b568ef806ec79ba3777f.jpeg', 1, 8, 'src/tn/edu/esprit/images/26e7ff4a43c2b568ef806ec79ba3777f.jpeg', 'azeazeaze', 'null');
...
(1, 'yakoubi.marwen@esprit.tn', '1234', 'Marwen', 'Yakoubi', '1998-05-14', 'homme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love lablebi. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 50, 18, 35, 'ESPRIT', 36.8991643, 10.1879781, 24122, 0, '8nlj7ok_NZv1_7B4BXWJo75iRWxx0sXloaA6vmvSDNw'),
(2, 'eya.benromdhane@esprit.tn', '1234', 'Eya', 'Benromdhane', '2001-05-12', 'femme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love sushi. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 10, 18, 50, 'ESPRIT', 36.87427, 10.27263, 22211, 0, NULL),
(3, 'sondes@esprit.tn', '1234', 'Sondes', 'kharroubi', '1996-05-14', 'femme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love hargma. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 10, 18, 50, 'ISI', 36.85858, 10.18436, 21422, 0, NULL),
(21, 'wassimbenr@gmail.com', '1234', 'Wassim', 'Ben R', '1985-09-01', 'Homme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love Coffee. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 10, 18, 50, 'MSB', 36.800481, 10.187607, 41212, 0, NULL),
(22, 'said@esprit.tn', '1234', 'Said', 'Mohamed', '2022-06-16', 'Homme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love chawarma. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 10, 18, 50, 'ISET Gafsa', 34.42589577900697, 8.777963316936145, 11121, 0, NULL),
(23, 'lina@esprit.tn', '1234', 'Lina', 'Toumi', '2003-03-08', 'Femme', 94366666, '6dbc43f038cc901819f39401c5eea389.jpeg', 'I love Crepe. Et quibusdam accusamus sed voluptas consectetur est temporibus dignissimos?', 10, 18, 50, 'INSAT', 36.91971402746499, 10.282887734817388, 12444, 0, NULL);
...
--
ALTER TABLE `reservation`
  MODIFY `id_reservation` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT pour la table `restaurant`
--
ALTER TABLE `restaurant`
  MODIFY `id_restaurant` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
